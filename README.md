...
1. [Fuzzing device and host](#Fuzzing)
	- [Fuzzing the device](#Devfuzz)
		a. [Random fuzzer](#Device-random-fuzzer)
		b. [Sequential Fuzzer](#Device-sequential-fuzzer)
		c. [Smart Fuzzer](#Device-smart-fuzz)
		d. [Describe fuzzer](#Describe-fuzzer)
		e. [Control Transfer Enumerator](#Control-Transfer-Enumerator)
		f. [Send packet to device](#senddev)
	- [Fuzzing the host](#Hostfuzz)
		a. [Random fuzzer](#Host-random-fuzzer)
		b. [Smart Fuzzer](#Host-smart-fuzzer)
		c. [Gadget fuzzer](#Host-gadget-fuzzer)
		d. [Send packet to host](#sendhst)
1. [Help](#Help)
