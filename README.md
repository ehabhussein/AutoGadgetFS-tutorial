# [AutoGadgetFS tutorial](#autogadgetfs-tutorial)
  - [Selecting your device (Configuration, Interface, Alternate Settings, Endpoints)](#selecting-your-device)
  - [Emulating the selected device](#Emulating-the-selected-device)
  - [Starting the router on the Pi Zero](#Starting-the-router-on-the-Pi-Zero)
  - [Fuzzing device and host](#Fuzzing)
  	- [Fuzzing the device](#Devfuzz)
		- [Random fuzzer](#Device-random-fuzzer)
		- [Sequential Fuzzer](#Device-sequential-fuzzer)
		- [Smart Fuzzer](#Device-smart-fuzz)
		- [Describe fuzzer](#Describe-fuzzer)
		- [Control Transfer Enumerator](#Control-Transfer-Enumerator)
	- [Fuzzing the host](#Hostfuzz)
		- [Random fuzzer](#Host-random-fuzzer)
		- [Smart Fuzzer](#Host-smart-fuzzer)
		- [Gadget fuzzer](#Host-gadget-fuzzer)
  - [Help](#Help)
